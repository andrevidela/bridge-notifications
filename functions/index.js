 ...
 */
exports.sendToAllUsers = onRequest({cors: true}, async (req, res) => {
  if (req.method === "OPTIONS") {
    res.status(204).send("");
    return;
  }
 ...
 * Runs every day at 9 AM Eastern Time
 *
 * OPTIONAL: Comment out if you don't want scheduled emails
 */
 ...
 */
exports.cleanupOldSubscriptions = onSchedule({
  schedule: "0 0 * * 0",
  timeZone: "UTC",
}, async (event) => {
  try {
